  ...
  Future<void> _loadContinueLesson() async {
    ...
    try {
      ...
      int totalFor(String moduleId) {
          if (moduleId == 'discrete_math_beginner_ch1') return BeginnerDiscreteMathQuiz.questions.length;
          if (moduleId == 'discrete_math_intermediate_ch1') return IntermediateDiscreteMathQuiz.questions.length;
        if (moduleId == 'discrete_math_advanced_ch1') return AdvancedDiscreteMathQuiz.questions.length;
        return 0;
      }
