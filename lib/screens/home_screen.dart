  ...
  Future<void> _loadContinueLesson() async {
    ...
    try {
      ...
      int totalFor(String moduleId) {
          if (moduleId == 'oop_beginner_ch1') return BeginnerOOPQuiz.questions.length;
          if (moduleId == 'oop_intermediate_ch1') return IntermediateOOPQuiz.questions.length;
        if (moduleId == 'oop_advanced_ch1') return AdvancedOOPQuiz.questions.length;
        return 0;
      }
