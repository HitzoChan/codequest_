    ...
    try {
      ...
      // helper: total questions per moduleId
        int totalFor(String moduleId) {
            if (moduleId == 'it_pm_beginner_ch1') return BeginnerITPMQuiz.questions.length;
          if (moduleId == 'it_pm_intermediate_ch1') return IntermediateITPMQuiz.questions.length;
        if (moduleId == 'it_pm_advanced_ch1') return AdvancedITPMQuiz.questions.length;
        return 0;
      }
