  ...
  Future<void> _loadContinueLesson() async {
    ...
    try {
      ...
      int totalFor(String moduleId) {
          if (moduleId == 'ip_beginner_ch1') return BeginnerIntegrativeProgrammingQuiz.questions.length;
          if (moduleId == 'ip_intermediate_ch1') return IntermediateIntegrativeProgrammingQuiz.questions.length;
        if (moduleId == 'ip_advanced_ch1') return AdvancedIntegrativeProgrammingQuiz.questions.length;
        return 0;
      }
