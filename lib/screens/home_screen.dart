  ...
  Future<void> _loadContinueLesson() async {
    ...
    try {
      ...
      int totalFor(String moduleId) {
          if (moduleId == 'hci_beginner_ch1') return BeginnerHCIQuiz.questions.length;
          if (moduleId == 'hci_intermediate_ch1') return IntermediateHCIQuiz.questions.length;
        if (moduleId == 'hci_advanced_ch1') return AdvancedHCIQuiz.questions.length;
        return 0;
      }
