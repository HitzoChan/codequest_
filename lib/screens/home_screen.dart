  ...
  Future<void> _loadContinueLesson() async {
    ...
    try {
      ...
      int totalFor(String moduleId) {
          if (moduleId == 'dsa_beginner_ch1') return BeginnerDSAQuiz.questions.length;
          if (moduleId == 'dsa_intermediate_ch1') return IntermediateDSAQuiz.questions.length;
        if (moduleId == 'dsa_advanced_ch1') return AdvancedDSAQuiz.questions.length;
        return 0;
      }
