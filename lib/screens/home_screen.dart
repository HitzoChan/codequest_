  ...
  Future<void> _loadContinueLesson() async {
    ...
    try {
      ...
      int totalFor(String moduleId) {
          if (moduleId == 'l_beginner_ch1') return BeginnerDigitalLiteracyQuiz.questions.length;
          if (moduleId == 'dl_intermediate_ch1') return IntermediateDigitalLiteracyQuiz.questions.length;
        if (moduleId == 'dl_advanced_ch1') return AdvancedDigitalLiteracyQuiz.questions.length;
        return 0;
      }
