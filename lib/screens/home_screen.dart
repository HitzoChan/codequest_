  ...
  Future<void> _loadContinueLesson() async {
    ...
    try {
      ...
      int totalFor(String moduleId) {
          if (moduleId == 'css_beginner_ch1') return BeginnerCSSQuiz.questions.length;
          if (moduleId == 'css_intermediate_ch1') return IntermediateCSSQuiz.questions.length;
        if (moduleId == 'css_advanced_ch1') return AdvancedCSSQuiz.questions.length;
        return 0;
      }
