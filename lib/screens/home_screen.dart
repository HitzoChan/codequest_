    ...
    try {
      ...
      // helper: total questions per moduleId
        int totalFor(String moduleId) {
            if (moduleId == 'ai_beginner_ch1') return BeginnerAIQuiz.questions.length;
          if (moduleId == 'ai_intermediate_ch1') return IntermediateAIQuiz.questions.length;
        if (moduleId == 'ai_advanced_ch1') return AdvancedAIQuiz.questions.length;
        return 0;
      }
