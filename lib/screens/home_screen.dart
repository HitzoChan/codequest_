  ...
  Future<void> _loadContinueLesson() async {
    ...
    try {
      ...
      int totalFor(String moduleId) {
          if (moduleId == 'se_beginner_ch1') return BeginnerSoftwareEngineeringQuiz.questions.length;
          if (moduleId == 'se_intermediate_ch1') return IntermediateSoftwareEngineeringQuiz.questions.length;
        if (moduleId == 'se_advanced_ch1') return AdvancedSoftwareEngineeringQuiz.questions.length;
        return 0;
      }
