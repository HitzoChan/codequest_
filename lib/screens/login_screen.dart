...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _handleEmailLogin() async {
    ...
    try {
      ...
      // Update or create profile to sync Firebase Auth user info
      ...
      if (uid != null) {
        ...
        if (profile == null) {
          ...
          _userProfileService.updateProfile(uid, name: displayName, email: emailValue);
        }
      }
  ...
  Future<void> _handleGoogleSignIn() async {
    ...
    try {
      ...
      // Sync Firestore users collection with Google user info
      final uid = userCredential.user?.uid;
      ...
      // Maintain sync with local UserProfileService
      if (uid != null) {
        final profile = _userProfileService.getProfile(uid);
        if (profile == null) {
          _userProfileService.createProfile(uid, displayName, emailValue);
