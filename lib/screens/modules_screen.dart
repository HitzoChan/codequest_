...
class _ModulesScreenState extends State<ModulesScreen> {
  ...
  Future<void> _loadQuizProgress() async {
    try {
      ...
      latestScore.forEach((quizId, scoreInt) {
        int total = 0;
        if (quizId == 'ai_beginner_ch1') { total = BeginnerAIQuiz.questions.length; }
        else if (quizId == 'ai_intermediate_ch1') { total = IntermediateAIQuiz.questions.length; }
        else if (quizId == 'ai_advanced_ch1') { total = AdvancedAIQuiz.questions.length; }
  ...
  Widget _buildModuleCard(Module module) {
    ...
    int total = 0;
    if (module.moduleId == 'ai_beginner_ch1') {
      total = BeginnerAIQuiz.questions.length;
    } else if (module.moduleId == 'ai_intermediate_ch1') {
      total = IntermediateAIQuiz.questions.length;
    } else if (module.moduleId == 'ai_advanced_ch1') {
      total = AdvancedAIQuiz.questions.length;
    }
