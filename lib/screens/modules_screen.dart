...
class _ModulesScreenState extends State<ModulesScreen> {
  ...
  Future<void> _loadQuizProgress() async {
    try {
      ...
      latestScore.forEach((quizId, scoreInt) {
        int total = 0;
        if (quizId == 'ip_beginner_ch1') { total = BeginnerIntegrativeProgrammingQuiz.questions.length; }
        else if (quizId == 'ip_intermediate_ch1') { total = IntermediateIntegrativeProgrammingQuiz.questions.length; }
        else if (quizId == 'ip_advanced_ch1') { total = AdvancedIntegrativeProgrammingQuiz.questions.length; }
  ...
  Widget _buildModuleCard(Module module) {
    ...
    int total = 0;
    if (module.moduleId == 'ip_beginner_ch1') {
      total = BeginnerIntegrativeProgrammingQuiz.questions.length;
    } else if (module.moduleId == 'ip_intermediate_ch1') {
      total = IntermediateIntegrativeProgrammingQuiz.questions.length;
    } else if (module.moduleId == 'ip_advanced_ch1') {
      total = AdvancedIntegrativeProgrammingQuiz.questions.length;
    }
