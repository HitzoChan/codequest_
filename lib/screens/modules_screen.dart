...
class _ModulesScreenState extends State<ModulesScreen> {
  ...
  Future<void> _loadQuizProgress() async {
    try {
      ...
      latestScore.forEach((quizId, scoreInt) {
        int total = 0;
        if (quizId == 'os_beginner_ch1') { total = BeginnerOSQuiz.questions.length; }
        else if (quizId == 'os_intermediate_ch1') { total = IntermediateOSQuiz.questions.length; }
        else if (quizId == 'os_advanced_ch1') { total = AdvancedOSQuiz.questions.length; }
  ...
  Widget _buildModuleCard(Module module) {
    ...
    int total = 0;
    if (module.moduleId == 'os_beginner_ch1') {
      total = BeginnerOSQuiz.questions.length;
    } else if (module.moduleId == 'os_intermediate_ch1') {
      total = IntermediateOSQuiz.questions.length;
    } else if (module.moduleId == 'os_advanced_ch1') {
      total = AdvancedOSQuiz.questions.length;
    }
