...
class _ModulesScreenState extends State<ModulesScreen> {
  ...
  Future<void> _loadQuizProgress() async {
    try {
      ...
      latestScore.forEach((quizId, scoreInt) {
        int total = 0;
        if (quizId == 'hci_beginner_ch1') { total = BeginnerHCIQuiz.questions.length; }
        else if (quizId == 'hci_intermediate_ch1') { total = IntermediateHCIQuiz.questions.length; }
        else if (quizId == 'hci_advanced_ch1') { total = AdvancedHCIQuiz.questions.length; }
  ...
  Widget _buildModuleCard(Module module) {
    ...
    int total = 0;
    if (module.moduleId == 'hci_beginner_ch1') {
      total = BeginnerHCIQuiz.questions.length;
    } else if (module.moduleId == 'hci_intermediate_ch1') {
      total = IntermediateHCIQuiz.questions.length;
    } else if (module.moduleId == 'hci_advanced_ch1') {
      total = AdvancedHCIQuiz.questions.length;
    }
