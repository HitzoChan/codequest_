...
class _ModulesScreenState extends State<ModulesScreen> {
  ...
  Future<void> _loadQuizProgress() async {
    try {
      ...
      latestScore.forEach((quizId, scoreInt) {
        int total = 0;
        if (quizId == 'sql_beginner_ch1') { total = BeginnerSQLQuiz.questions.length; }
        else if (quizId == 'sql_intermediate_ch1') { total = IntermediateSQLQuiz.questions.length; }
        else if (quizId == 'sql_advanced_ch1') { total = AdvancedSQLQuiz.questions.length; }
  ...
  Widget _buildModuleCard(Module module) {
    ...
    int total = 0;
    if (module.moduleId == 'sql_beginner_ch1') {
      total = BeginnerSQLQuiz.questions.length;
    } else if (module.moduleId == 'sql_intermediate_ch1') {
      total = IntermediateSQLQuiz.questions.length;
    } else if (module.moduleId == 'sql_advanced_ch1') {
      total = AdvancedSQLQuiz.questions.length;
    }
