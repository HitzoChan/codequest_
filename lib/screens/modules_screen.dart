...
class _ModulesScreenState extends State<ModulesScreen> {
  ...
  Future<void> _loadQuizProgress() async {
    try {
      ...
      latestScore.forEach((quizId, scoreInt) {
        int total = 0;
        if (quizId == 'dsa_beginner_ch1') { total = BeginnerDSAQuiz.questions.length; }
        else if (quizId == 'dsa_intermediate_ch1') { total = IntermediateDSAQuiz.questions.length; }
        else if (quizId == 'dsa_advanced_ch1') { total = AdvancedDSAQuiz.questions.length; }
  ...
  Widget _buildModuleCard(Module module) {
    ...
    int total = 0;
    if (module.moduleId == 'dsa_beginner_ch1') {
      total = BeginnerDSAQuiz.questions.length;
    } else if (module.moduleId == 'dsa_intermediate_ch1') {
      total = IntermediateDSAQuiz.questions.length;
    } else if (module.moduleId == 'dsa_advanced_ch1') {
      total = AdvancedDSAQuiz.questions.length;
    }
